...
namespace Pong
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            //create bottom and top paddles ad set their initial position
            PaddleBottom = new Paddle(paddleTexture);
            PaddleTop = new Paddle(paddleTexture);

            //position both paddles with help of screenBounds object
            PaddleBottom.Position = new Vector2(screenBounds.Right - 2 * PaddleBottom.Size.Width, screenBounds.Bottom - PaddleBottom.Size.Height);
            PaddleTop.Position = new Vector2(screenBounds.Left, screenBounds.Top);

            //load ball texture
            Texture2D ballTexture = Content.Load<Texture2D>("ball");

            //create ball object and set its initial position
            Ball = new Ball(ballTexture);
            Ball.Position = screenBounds.Center.ToVector2();

            //load background texture and create new background object
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            // Walls
            var bounds = graphics.GraphicsDevice.Viewport.Bounds; if (Ball.Position.X < bounds.Left || Ball.Position.X > bounds.Right - Ball.Size.Width)
            {
                Ball.Direction.X = -Ball.Direction.X; Ball.Speed = Ball.Speed * Ball.BumpSpeedIncreaseFactor;
                HitSound.Play();
            }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //end drawing 
            // send all gathered details to the graphics card in one batch
            spriteBatch.End();
        ...
        /// SoundEffect is type defined in Monogame framework
        /// </summary>
        public SoundEffect HitSound { get; private set; }

        ///<summary>
        /// Background music. Song is type defined in Monogame framework
        /// </summary>
